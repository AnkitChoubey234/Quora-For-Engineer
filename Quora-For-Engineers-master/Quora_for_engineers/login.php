...
<body>
    ...
    <form id="loginform" action="http://localhost/Quora_for_engineers/login.php" method="post">
    ...
    <p>Don't have an account please register? <a href="http://localhost/Quora_for_engineers/signup.php"> Click here </a></p>
</body>
</html>
