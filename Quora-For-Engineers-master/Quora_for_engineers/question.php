...
<body>
            ...
            <ul class="navbar-nav">
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                  ...
                  <li><a class="dropdown-item" href="http://localhost/Quora_for_engineers/logout.php">Logout</a></li>
                  <li><a class="dropdown-item" href="http://localhost/Quora_for_engineers/feedback.php">Feedback</a></li>
                  <li><a class="dropdown-item" href="http://localhost/Quora_for_engineers/grievances.php">Grievances</a></li>
                </ul>
              </li>
            </ul>
          </div>
    ...
    <?php
      for($x=0;$x<$num;$x++){
        ...
        <form class="container btn-group mb-5" id="container-button" method="post" action="http://localhost/Quora_for_engineers/question.php"  >
          <p  >' .$question. '</p>
          <div class="uds">
      ...
      ?>
      <form action="http://localhost/Quora_for_engineers/question.php" class="container fixed-bottom" id="create-new" method="post">
