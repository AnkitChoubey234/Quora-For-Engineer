...
<body>
    ...
    <form id="signupform" action="http://localhost/Quora_for_engineers/signup.php" method="post">
    ...
    <p>Already have an account? <a href="http://localhost/Quora_for_engineers/login.php"> Click here </a></p>
</body>
</html>
